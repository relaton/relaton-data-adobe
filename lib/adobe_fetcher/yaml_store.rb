...
module AdobeFetcher
  ...
  # (via Relaton::Adobe::Item) all live here.
  #
  # Uses the Adobe-flavored Item so the typed ext fields (urn, webpage,
  # tech_note_number, source_repo_path, publication_slug) round-trip
  # natively — no merge hack.
  class YamlStore
    def initialize(dir)
    ...
    def write(name, hash, overwrite: true)
      ...
      item = Relaton::Adobe::Item.from_hash(hash, {})
